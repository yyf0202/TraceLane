#!/usr/bin/env python3
"""Resume Day 3 after replacing BR-11's name-bound v2 adjudicator."""
...
INTERRUPTED = "day3v2-br-11-dsv4pro-r2-direct-build"
RESTART_SUFFIX = "operator-restart-br11-v3"
ADJUDICATOR = (
    day3.ROOT / "tests/fixtures/coding_tasks/br11_hidden_acceptance_v3.py"
)
...
def adjudicate_br11(spec: execution.AttemptSpec) -> None:
    ...
    destination = raw / "adjudicated-grader-v3.log"
    if destination.exists():
        raise ValueError(f"BR-11 v3 output already exists: {destination}")
