#!/usr/bin/env python3
"""Resume Day 3 using the array-aware BR-12 V3 adjudicator."""
...
COMPLETED = (
    "day3v2-br-12-k2.7code-r2-direct-build-"
    "operator-restart-br12-plan-gate-v5"
)
INTERRUPTED = "day3v2-br-12-glm52-r1-plan-build"
RESTART_SUFFIX = "operator-restart-br12-grader-v3"
PLAN_GATE = (
    recovery.day3.ROOT
    / "tests/fixtures/coding_tasks/day3_plan_acceptance_v5.py"
)
ADJUDICATOR = (
    recovery.day3.ROOT
    / "tests/fixtures/coding_tasks/br12_hidden_acceptance_v3.py"
)
